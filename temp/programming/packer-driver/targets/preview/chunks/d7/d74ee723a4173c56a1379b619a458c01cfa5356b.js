System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, MeshRenderer, Vec3, Vec4, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Mass;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Material', 'MeshRenderer', 'Node', 'Vec3', 'Vec4']);
      ...
      _export("Mass", Mass = (_dec = ccclass('Mass'), _dec2 = property(Number), _dec3 = property(Number), _dec(_class = (_class2 = class Mass extends Component {
        ...
        start() {
          ...
          this.bound = bound; // this.max = bound.center.y*2.0;
        ...
        update(deltaTime) {
          ...
          this.node.position = this._moveDir; //进行一些受力, 加速度, 速度, 路程, 运动 的数值计算
...
//# sourceMappingURL=d74ee723a4173c56a1379b619a458c01cfa5356b.js.map